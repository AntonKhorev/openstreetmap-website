  ...
  class WaysControllerTest < ActionDispatch::IntegrationTest
    ...
    def test_create_by_private_user
      ...
      assert_no_difference "Way.count" do
        post api_ways_path, :params => xml, :headers => bearer_authorization_header(user)
    ...
    def test_create
      ...
      assert_equal user.id, way.changeset.user_id, "saved way does not belong to user that created it"
