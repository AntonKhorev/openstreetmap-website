...
module Api
  class WaysControllerTest < ActionDispatch::IntegrationTest
    ...
    def test_index_nonexisting
      get api_ways_path(:ways => "0")

      assert_response :not_found
    end

    def test_index_existing_and_nonexisting
      way = create(:way)
    ...
    def test_index_with_and_without_versions
      ...
      assert_dom "osm" do
        ...
        assert_dom "way[id='#{way1.id}'][version='1']", :count => 1
        assert_dom "way[id='#{way2.id}'][version='1']", :count => 1
        assert_dom "way[id='#{way2.id}'][version='2']", :count => 1
      end
    end
